...
def horoscopo(signo_desejado):
    ...
    signo_formatado = remover_acentos(signo_desejado).lower()  # Formata o signo desejado
    minha_url = 'https://www.horoscopovirtual.com.br/horoscopo/' + signo_formatado  # Constrói a URL do horóscopo
